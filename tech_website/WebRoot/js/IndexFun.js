							...
							var G = function(N, K, T) {
								...
								for (var O = 0; O < R; O++) {
									...
									var L = '<div class="g-hotL-list" '
											...
											+ '<li><a href="products/'
											+ M[O].goodsID
											+ '.html" class="u-imm" target="_blank" title="立即1元夺宝">立即1元夺宝</a></li></ul></div><div class="u_buyCount" style="top:169px;" codeid="'
											+ M[O].codeID + '"></div></div>';
									var Q = $(L);
									Q.hover(function() {
							...
							var G = function(R, M, V) {
								...
								for (var S = 0; S < U; S++) {
									...
									var N = '<div class="soon-list-con" idx="'
											...
											+ '<li><a href="products/'
											+ P[S].goodsID
											+ '.html" target="_blank" title="立即1元夺宝"  class="u-now">立即1元夺宝</a><a href="javascript:;"  title="加入到购物车" codeid="'
											+ P[S].codeID
											+ '" surplus="'
											+ K
