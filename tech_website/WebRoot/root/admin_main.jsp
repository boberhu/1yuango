...
<head>
  ...
  <body<d:getProperty property="body.id" writeEntireProperty="true" /><d:getProperty property="body.name" writeEntireProperty="true" /><d:getProperty property="body.class" writeEntireProperty="true" /><d:getProperty property="body.rf" writeEntireProperty="true" />>
<!--<div align="center">-->
...
<div class="navbar navbar-default navbar-fixed-top" id="head-nav">
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <a href="#" class="navbar-brand" style="overflow: hidden; height: 34px;"><span><%=ApplicationListenerImpl.sysConfigureJson.getSaitName()%>管理中心</span></a>
      </div>
    ...
    <ul class="nav navbar-nav navbar-right user-nav">
      <li class="dropdown profile_menu">
        ...
        <ul class="dropdown-menu">
          <li><a href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>" target="_blank">网站首页</a></li>
          <li class="divider"></li>
  ...
  <div id="cl-wrapper" class="fixed-menu">
	  <!-- 左侧开始 -->
  <div data-intro="&lt;strong&gt;Fixed Sidebar&lt;/strong&gt; &lt;br/&gt; It adjust to your needs." data-step="1" data-position="right" class="cl-sidebar">
        ...
        <div class="menu-space nano nscroller has-scrollbar" style="height: 505px;">
          <div class="content" tabindex="0" style="right: -17px;">
            <div class="side-user">
              ...
              <div class="info">
                <a href="#"><%=ApplicationListenerImpl.sysConfigureJson.getSaitName()%></a>
            ...
            <ul class="cl-vnavigation">
              ...
              <li><a href="/admin_back/productTypeList.action"><i class="fa fa-text-height">商品分类管理</i></a></li>                  
              <li><a href="/admin_back/latestList.action"><i class="fa fa-text-height">揭晓商品管理</i></a></li>             
              <li><a href="/admin_back/shareList.action?typeId=hot20"><i class="fa fa-text-height">商品晒单管理</i></a></li>
              <li><a href="/admin_back/orderdetailaddressList.action"><i class="fa fa-text-height">发货管理</i></a></li>
        ...
        <div class="pane" style="display: none;"><div class="slider" style="height: 426px; top: 0px;"></div></div></div>
