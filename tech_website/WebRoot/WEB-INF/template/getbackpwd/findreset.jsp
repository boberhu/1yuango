  ...
  <body>
  	...
  	<div class="login_layout">
        ...
        <div class="login_ConInput login_Ptxtf14">
	        ...
	        <dl>
		        <dt>确认密码：</dt>
		        <dd><input type="password" value="" class="login_input_text" name="txtPasswordAgain" id="passwordAgain" /></dd>
		        <dd></dd>
	        </dl>
    ...
    <script language="javascript" type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/findreset.js"></script>
  </body>
</html>
