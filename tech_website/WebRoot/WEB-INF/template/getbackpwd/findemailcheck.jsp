...
<html>
  ...
  <body>
  	<div class="login_layout">    
	    ...
	    <div class="login_Content">
		    ...
		    <div class="login_CMobile_Complete" id="divNormal">
			    <p><%=ApplicationListenerImpl.sysConfigureJson.getSaitName() %>已向您的 <span class="orange">${mail}</span> 邮箱发送了一封验证邮件，请前往收信，完成验证！</p>
			    <a target="_blank" href="http://mail.${fn:substring(mail,fn:indexOf(mail,'@')+1,fn:length(mail))}" class="login_Email_but" id="hylinkMails">登录邮箱完成验证</a>
    ...
    <script language="javascript" type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/findemailcheck.js"></script>
  </body>
</html>
