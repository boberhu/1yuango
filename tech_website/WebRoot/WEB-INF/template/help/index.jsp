	...
	<div class="GuideW">
		...
		<div class="Guidebor clearfix">
			...
			<div class="Rule clearfix Rulemat">
				...
				<ul class="Rule-Exp">
					<li>取该商品最后购买时间前网站所有商品100条购买时间记录。</li>
					<li>时间按时、分、秒、毫秒依次排列组成一组数值。如20:15:25.362则为201525362）将这100个时间的数值进行求和</li>
					<li>将这100组数值之和除以商品总需参与人次后取余数，余数加上10,000,001即为“幸运<%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>码”。</li>
				</ul>
			</div>
