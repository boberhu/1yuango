...
<li class="poa-2"><a class="cur" >好友<s></s></a></li></ul></div>
            <div class="New-content">
            <p class="get-tips gray02" id="pTopTip"></p>
			<ul class="friend-con" id="pageListItems">
			</ul>
    ...
    <script type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/userfriends.js"></script>
