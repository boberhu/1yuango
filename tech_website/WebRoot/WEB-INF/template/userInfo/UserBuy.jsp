...
<li class="poa-4"><a class="cur"><%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>记录<s></s></a></li>
...
<li class="poa-2"><a href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/${user.userId }-userFriends.html">好友<s></s></a></li></ul></div>
			...
			<ul id="pageListItems" class="get-com clearfix">
			</ul>
    ...
    <script type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/userbuy.js"></script>
