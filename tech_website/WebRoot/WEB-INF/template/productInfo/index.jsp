...
<html>
  <head>
    ...
    <title>${product.productName }${product.productTitle }_<%=ApplicationListenerImpl.sysConfigureJson.getSaitName()%> 一元<%=ApplicationListenerImpl.sysConfigureJson.getShortName() %> <%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>网</title>
...
<div class="show_content">
	    ...
	    <div class="Pro_Details">
		    ...
		    <div class="Pro_Detright">
			        <p class="Det_money">价值：<span class="rmbgray" style="color: #f60000;font-size: 18px;" >${product.productPrice }.00</span></p>
			        <p class="Det_money">商品编号：${product.productId }</p>
			        
			        <div class="Progress-bar">
			        </div>
			        <p class="Pro_Detsingle">
			        </p><div class="Det_button" id="divBuy">
				        <a class="Det_Shopbut"  prId="${product.productId }" price="${product.productPrice }" name="goPay" href="javascript:;">立即购买</a>
			        </div>
			        <div class="Security">
...
<!--</div>-->
	<!-- 人气推荐结束 -->
    <script language="javascript" type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/productinfo.js"></script>
