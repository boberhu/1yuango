...
<html>
  ...
  <body>
  	<div class="logo">
        <div class="float"> 
            <span class="logo_pic"><a title="<%=ApplicationListenerImpl.sysConfigureJson.getSaitName()%>" class="a" href="/index.html"></a></span><span class="tel"><a style="color:#999;" href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>">返回首页</a></span>
        </div>
    </div>
    <div class="shop_process">
        ...
        <div class="submitted">
            <ul class="order">
                <li class="top"><span class="goods">商品</span><span class="name" style="width:458px;">名称</span><span class="moneys" style="width:150px;">市场价</span><span class="xj" style="width:150px;">小计</span><span class="do" style="width:150px;">操作</span></li>
                     ...
                     <li class="end">
                         ...
                         <span class="goods">
                             <input type="checkbox" checked="checked" class="check" />
                             	<a title="${productCarts.productName } ${productCarts.productTitle }" href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/productInfo/${productCarts.productId }.html">
                                 <img src="<%=ApplicationListenerImpl.sysConfigureJson.getImgUrl()%>${productCarts.headImage }" /></a></span> 
                                 <span><span class="name" style="width:480px;"><a style="width:480px;" title="${productCarts.productName } ${productCarts.productTitle }" href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/productInfo/${productCarts.productId }.html">
                ...
                <li><div class="cartno" id="cartNO"></div></li>
                <li class="ts">
                    <p class="left">
                        <input type="checkbox" checked="checked" id="ckAll"><a class="all" href="javascript:;"><label for="ckAll">全选</label></a><a id="AllDelete" class="del" href="javascript:;">批量删除</a></p>
                    <p class="right"><%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>金额总计:￥<span id="moneyCount">0.00</span></p>
                </li>
            </ul>
        </div>
        <h5>
    ...
    <script language="javascript" type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/cartbuylist.js"></script>
