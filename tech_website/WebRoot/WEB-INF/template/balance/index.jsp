	   	...
	   	<div class="wait_list hidden" id="divResult" style="display: block;">
	   		<c:choose>
	   			<c:when test="${paymentStatus == 'success' }">
				        ...
				        <p>您现在可以 <a class="blue" href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/user/UserBalance.html">查看充值记录</a> 或 <a class="blue" href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>">继续购物</a></p>
				    </div>
	   			</c:when>
	   			<c:otherwise>
	   				<div class="wait_list_tips ">
