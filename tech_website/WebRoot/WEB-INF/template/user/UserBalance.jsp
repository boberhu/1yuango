...
<ul><li class="sid-cur"><a href="/user/UserBalance.html">账户明细</a></li>
...
<script type="text/javascript">
    ...
    $("div.sidebar-nav").find("h3").each(function(i,v){
		...
		<div class="R-content">
            ...
            <div class="last">
                <ul>
                    <li><h3>您的账户可用余额为：</h3><b class="orange">${user.balance }</b>元 <a title="充值" class="bluebut" href="/user/UserRecharge.html">充值</a></li>
                </ul>
            </div>
            <div class="type">
                <a class="annal1" href="javascript:;">充值记录</a>
                <a href="javascript:;">消费记录</a>
            </div>
            <div class="record-tit" id="divTimeSel">
                <div class="record-tab">
	                <a class="record-cur" href="javascript:;">全部</a>
            ...
            <div class="list-tab recordList" id="divList0">
            </div>
	        <div style="display:none;" class="list-tab recordList" id="divList1">
	        </div>
	        <div style="display:none;" class="page_nav" id="divPageNav1"></div>
	        <div style="display:none;" class="count" id="divDetailInfo"></div>
	        <div style="display:none;" class="list-tab recordList buyDetail" id="divbuyDetail"></div>
    ...
    <script language="javascript" type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/userbalance.js?data=20151008"></script>
