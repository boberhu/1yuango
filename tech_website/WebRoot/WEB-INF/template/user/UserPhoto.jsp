...
<html>
  <head>
    ...
    <title>修改头像_<%=ApplicationListenerImpl.sysConfigureJson.getSaitName()%></title>
    ...
    <link rel="stylesheet" type="text/css" href="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/css/userphoto.css?data=20131121" />
    <link rel="stylesheet" type="text/css" href="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/css/imgareaselect-animated.css?data=20131121" />
...
<script type="text/javascript">
            ...
            <div class="uploadCon">
                <div class="upLeft">
                    <div class="upload">
                        ...
                        <form enctype="multipart/form-data" target="upFrame" action="/user/updateFaceFile.html" method="post" name="pageForm" id="pageForm">
                        ...
                        <div class="localBtn">
                            ...
                            <div class="btnFile" id="FileControl" style="top: -5px; left: -100.5px;">
                                <input type="file" style="cursor: pointer;" hidefocus="true" name="myFile" class="file" accept="image/*" title="" id="fuploadFace" />
                            </div>
                        </div>
                        </form>
                    </div>
                    <div class="frameCut">
                        ...
                        <div class="pic">
                            <img width="300" height="300" style="display: none;" id="imgPhoto" src="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/Images/defaultUserFace.png" />
                        </div>
                    </div>
                ...
                <div class="upRight">
                    ...
                    <div class="photo gray02">
                        <ul>
               			 <li class="li160"><div class="w160"><div id="w160">
                           <img width="160" height="160" border="0" id="img160" src="${user.faceImg }" />
                           </div></div>160X160 像素</li>
                           <li class="li80"><div class="w80"><div id="w80">
                           <img width="80" height="80" border="0" id="img80" src="${user.faceImg }" />
                           </div></div>80X80 像素</li>
                           <li class="li30"><div class="w30"><div id="w30">
    ...
    <script language="javascript" type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/jquery.imgareaselect.pack.js"></script>
    <script language="javascript" type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/userphoto.js?data=20131121"></script>
