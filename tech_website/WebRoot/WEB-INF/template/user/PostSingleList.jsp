...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/css/layoutsingle.css?data=20131121" />
...
<script type="text/javascript">
	...
	<div class="R-content">
            ...
            <div class="subMenu">
                <a class="current" title="已晒单" href="javascript:;">已晒单<span id="postCount"></span></a>
                <a title="未晒单" href="javascript:;">未晒单<span id="unPostCount"></span></a>
            </div>
	        <div class="single-titR">成功晒单并通过审核立即获得积分</div>
	        <div class="single-C list-tab" id="PostList0">
...
<!--		        <div class="tips-con"><i></i>暂无记录！</div>-->
	        ...
	        <div style="display:none;" class="single-C list-tab" id="PostList1">
<!--	   	        <ul class="listTitle"><li class="single-img">晒单图片</li><li class="single-xx-has">晒单信息</li><li class="sdzt">晒单状态</li><li class="single-Control">操作</li></ul>-->
<!--		        <div class="tips-con"><i></i>暂无记录！</div>-->
	        </div>
	        <div style="display:none;" class="page_nav" id="divPageNav0"></div>
    ...
    <script language="javascript" type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/postsinglelist.js?data=20131121"></script>
</body>
</html>
