...
<div class="R-content">
        ...
        <div class="get-pro gray02">您总共成功<%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>获得商品 <b class="orange" id="goodsCount">${resultCount }</b> 个</div>
        ...
        <div class="single-C list-tab" id="tbList">
        <ul class="listTitle"><li class="single-img">商品图片</li><li class="single-xx-has">商品信息</li><li class="sdzt">状态</li><li class="single-Control">操作</li></ul>
    ...
    <script language="javascript" type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/orderlist.js?data=20131121"></script>
