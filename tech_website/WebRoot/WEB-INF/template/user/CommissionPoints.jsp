...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/css/layoutfriend.css?data=20131121" />
...
<p class="sid-line"></p><h3 url="" haschild="0" class="sid-icon07 sid-hcur"><a href="/user/MemberPoints.html"><b></b>我的积分</a></h3>
...
<div class="R-content">
	...
	<div class="member-t"><h2>我的积分</h2></div>
	<div class="over">
        <ul>
            <li><h3>可用积分：</h3><b class="orange r10">${user.commissionPoints }</b>(<%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>时可抵扣现金<fmt:formatNumber type="number" value="${(user.commissionPoints/100 )-0.5} " maxFractionDigits="0"/>元)&nbsp;&nbsp;<a title="如何获得积分" target="_blank" href="/help/userExperience.html">如何获得积分？</a></li>
        </ul>
    </div>
     <div class="list-tab detailCon" id="divCommissionList">
   </div>
    ...
    <script language="javascript" type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/commissionpoints.js?data=20131121"></script>
