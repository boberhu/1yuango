...
<script type="text/javascript">
	...
	<div class="R-content">
		<input type="hidden" value="${userId }" id="userId"/>
            ...
            <div class="prompt orange"><%=ApplicationListenerImpl.sysConfigureJson.getSaitName()%>不会以任何形式公开您的个人隐私，请放心填写！完善资料可获得<%=ApplicationListenerImpl.sysConfigureJson.getUserData()%>积分。<s></s></div>
            <div class="info">
                    ...
                    <c:choose>
                    	<c:when test="${user.mobileCheck==0}">
                    		 <tr>
		                        ...
		                        <td><b>${user.phone }</b> 
<!--		                        <a title="修改" href="/user/MobileChecking.html">修改</a>-->
		                        <input type="hidden" class="txt gray" id="phone" value="${user.phone }" name="phone" />
		                         已验证</td>
		                    </tr>
                    	</c:when>
                    	<c:otherwise>
                             ...
                             <td>
		                        	还没绑定手机耶！
<!--		                        <span style=" position:relative; top:3px;"></span> 未验证-->
		                        <a title="验证" href="/user/MobileChecking.html">立即绑定</a>
		                         </td>
		                    </tr>
                    	</c:otherwise>
                    </c:choose>
                    <tr>
                        ...
                        <td>
                        <input type="text" value="${user.userName }" maxlength="20" class="txt gray" id="txtName" name="txtName" />
...
<!--                    </tr>-->
                    <tr>
                        ...
                        <td><textarea onpropertychange="if(value.length&gt;100) value=value.substr(0,100)" class="info_txtarea gray03" id="txtSignature" name="txtSignature">${user.signature }</textarea></td>
                    </tr>
                    <tr>
	                    <td>&nbsp;</td>
    ...
    <script language="javascript" type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/modify.js?data=20131124"></script>
