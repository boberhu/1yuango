...
<ul><li class="sid-cur"><a href="/user/InvitedList.html">邀请好友</a></li>
...
<div class="R-content">
  ...
  <div class="success-invitation gray02" id="divInvited">
   <p>复制链接邀请好友拿四重大礼！ <a class="blue" href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/referAuth.html" target="_blank">详情&gt;&gt;</a></p>
   <span><b></b><input type="text" onpaste="return false" value="" id="txtInfo"></span> <a class="bluebut" href="javascript:;" id="btnCopy">复制</a>
  </div>
    <div style="display: none;" class="get-tips gray01" id="divInviteInfo">成功邀请 <span class="orange">${resultCount}</span> 位会员注册，已有 <span class="orange">${w}</span> 位会员参与<%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>，您通过邀请获得奖励：<span class="orange">${h}</span> 积分</div>
    ...
    <script language="javascript" type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/invitedlist.js?data=20131121"></script>
