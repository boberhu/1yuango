...
<li class="sid-cur"><a href="/user/MentionList.html">提现记录</a></li></ul>
...
<script type="text/javascript">
	...
	<div class="R-content">
       ...
       <div class="member-t"><h2>提现记录</h2></div>
         <div class="record-tit">
           ...
           <div class="list-tab cash gray02" id="divMentionList">
           </div>
    ...
    <script language="javascript" type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/mentionlist.js?data=20131121"></script>
