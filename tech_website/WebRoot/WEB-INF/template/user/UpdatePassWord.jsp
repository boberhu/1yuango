...
<html>
  <head>
    ...
    <title>修改密码_<%=ApplicationListenerImpl.sysConfigureJson.getSaitName()%></title>
...
<script type="text/javascript">
	...
	<input type="hidden" value="${userId }" id="userId" name="userId" />
            ...
            <div class="pwdCon">
            <c:choose>
            	<c:when test="${user.attribute22!=null}">
            	<div class="pwdCon">
            		你是QQ互联登录用户无法修改密码
            	</div>
            	</c:when>
            	<c:otherwise>
                    ...
                    <tr>
                        ...
                        <td id="lNewPassAgain">请输入确认密码</td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
    ...
    <script language="javascript" type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/updatepassword.js?data=20131121"></script>
