...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/css/layoutrecords.css?data=20131121" />
...
<div class="R-content">
            ...
            <div class="member-t"><h2><%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>记录</h2></div>
<!--	        <div class="get-tips gray02" id="divStateList">-->
<!--		        <span class="gray02"><%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>提醒：</span>-->
<!--		            <a class="blue" val="2" href="javascript:;">即将揭晓商品<span class="orange">(0)</span></a>-->
<!--		            <a class="blue" val="1" href="javascript:;">进行中的商品<span class="orange">(0)</span></a>-->
<!--		            <a class="blue" val="3" href="javascript:;">已揭晓商品<span class="orange">(11)</span></a>-->
<!--		            <a class="blue" val="4" href="javascript:;">已退购商品<span class="orange">(0)</span></a>-->
<!--	        </div>-->
	        ...
	        <div class="goods_show" id="goods_list">
	        </div>
    ...
    <script type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/pagination.js?data=20131121"></script>
    <script language="javascript" type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/userbuylist.js?data=20131121"></script>
    <script language="javascript" type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/date.js?data=20131121"></script>
    <script language="javascript" type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/dateinput.js?data=20131121"></script>
</body>
</html>
