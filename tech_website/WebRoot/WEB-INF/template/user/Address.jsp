...
<html>
  <head>
    ...
    <title>收货地址_<%=ApplicationListenerImpl.sysConfigureJson.getSaitName()%></title>
...
<script type="text/javascript">
	...
	<div class="R-content">
        ...
        <div class="subMenu">
            ...
            <a class="current" href="/user/Address.html">收货地址</a>
            <a title="密码修改" href="/user/UpdatePassWord.html">密码修改</a>
        </div>
        <div class="list-tab detailAddress gray01" id="addressListDiv">
        </div>
        <div class="add"><input type="button" style="" value="新增收货地址" class="orangebut" id="btnAddnewAddr" /></div>            
        <div style="display:none;" class="addAddress" id="div_consignee"></div>
    </div>
    ...
    <script language="javascript" type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/address.js?data=20131121"></script>
