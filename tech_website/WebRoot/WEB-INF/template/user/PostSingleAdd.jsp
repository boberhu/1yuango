...
<script type="text/javascript">
	...
	<div class="R-content">
           <div class="member-t">
           		<a href="/user/OrderList.html" title="返回">&lt;&lt; 返回</a>
                <h2>晒单-发布晒单</h2>
            </div>
            <div class="myshare">
            <c:choose>
            	<c:when test="${empty latestlottery}">
            		<div class="text_myshare">该订单不属于您的，无法晒单...</div>
            	</c:when>
            	<c:otherwise>
	                <div class="text_myshare">
	                    ...
	                    <ul class="upload">
	                        <li><span class="titl">主&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题：</span><input type="text" class="title" name="title" value="标题不少于5个字" id="postTitle" /></li>
	                        <li><span class="content"><%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>感言：</span><textarea cols="30" rows="4" class="textarea" name="ads_code" id="postContent">恭喜您<%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>成功，在此输入您的<%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>感言吧，内容不少于100字，审核通过即可获得相应积分奖励哦！</textarea></li>
	                        <li><span class="pic">上传图片：</span>
	                            <div class="uppic">
	                                ...
	                                <br><br><div id="ulPicBox" class="pic">
	                                </div>
	                            </div>
	                        </li>
            ...
            <ul class="text">
               ...
               <li>5、建议晒出您与商品的合照，您的手机短信、邮件通知及<%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>网上的交易详情页面截图等；</li>
    ...
    <script language="javascript" type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/postsingleadd.js?data=20131121"></script>
