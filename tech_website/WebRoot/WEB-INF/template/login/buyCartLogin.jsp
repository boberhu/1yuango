  	...
  	<div class="login_register">
        <div class="shop_login" id="divLogin">
            ...
            <ul id="LoginForm">
                ...
                <li class="pad">
                    ...
                    <a href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/getbackpwd/index.html" target="_blank">忘记密码？</a>
                    </li>
            </ul>
        </div>
        <div class="registration">
            <div class="registration_txt">
                ...
                <a href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/register/index.html" target="_blank"><span class="regHrefStyle">立即注册>></span></a><br /><br />
...
var $domain = "<%=ApplicationListenerImpl.sysConfigureJson.getDomain()%>";
    ...
    <script language="javascript" type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/buycartlogin.js"></script>
</body>
</html>
