...
<table width="100%" class="lr10">
  ...
  <tr>
    <td>QQ 互联验证</td>
    <td><input type="text" value="${sysConfigure.qqVerify}" name="sysConfigure.qqVerify" class="input-text wid250" />
	</td>
  </tr> 
  <tr>
    <td>回调地址：</td>
    <td>
	${sysConfigure.wwwUrl }/qc_callback.html   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(网站域名/qc_callback.html )
	</td>
  </tr> 
	<tr>
    	<td width="100"></td> 
