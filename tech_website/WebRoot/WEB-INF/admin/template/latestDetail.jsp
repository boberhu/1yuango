...
<html>
  ...
  <body>
<div class="header-title lr10"><b>订单详情</b></div>
<div class="bk10"></div>
...
<input type="hidden" name="orderdetailaddress.orderRemarks" value="${orderdetailaddress.orderRemarks }"/>
  <table width="100%" cellspacing="0">	
		...
		<tr>
			...
			<td>${orderdetailaddress.expressNo }</td>
		</tr>	
		<tr>
			<td width="220" align="right">快递公司：</td>
			<td>${orderdetailaddress.expressCompany }</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>${orderdetailaddress.deliverRemarks }</td>
		</tr>	
        <tr>
