...
<html>
  ...
  <div class="header lr10">
	...
	<s:iterator value="productJSONList" var="productJSONs">
		<tr>
		<td align="center">${productJSONs.spellbuyProductId }</td>
		<td align="center">${productJSONs.productPeriod }</td>
		<td align="center"><a href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/products/${productJSONs.spellbuyProductId }.html" target="_blank">${productJSONs.productName }</a></td>
		<td align="center">${productJSONs.productPrice }</td>
		<td align="center">${productJSONs.currentBuyCount }</td>
		<td align="center"><img width="50px;" height="50px;" src="${productJSONs.headImage }"/></td>
		<td align="center"><a href="/admin_back/productPeriodList.action?id=${productJSONs.productId }">[查看详细]</a> <a href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/products/${productJSONs.spellbuyProductId }.html" target="_blank">[查看商品]</a> <a href="javascript:;" pid="${productJSONs.productId  }" name="indexTop">[首页推荐]</a></td>
	</tr>
	</s:iterator>
	</tbody>
	</table>
