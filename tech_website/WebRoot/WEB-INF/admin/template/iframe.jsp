...
<div id="header">
	<div class="logo"  style="width: 500px; padding: 20px; color: rgb(255, 255, 255); font-family: '黑体'; font-size: 36px;"><%=ApplicationListenerImpl.sysConfigureJson.getSaitName()%>管理中心</div>
    <div class="header_case">
    欢迎您：<a title="test" href="javascript:;"><%= ((Admin)request.getSession().getAttribute("admin")).getUserName() %> [超级管理员]</a>
    <a title="退出" href="/admin_back/logOut.action">[退出]</a>
    <a target="_blank" title="网站首页" href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>">网站首页</a>
...
<div id="left">
    <ul id="setting" class="left_date" style="display: none;">   
        ...
        <li><a src="/admin_back/roleList.action" href="javascript:;">系统角色</a></li>
     ...
     <ul id="content" class="left_date" style="display: none;">
        ...
        <li class="head">首页幻灯管理</li>
        <li><a src="/admin_back/indexImgAll.action" href="javascript:;">幻灯管理</a></li>
        <li><a src="/admin_back/toAddIndexImg.action" href="javascript:;">添加幻灯片</a></li>
        <li class="head">投诉建议管理</li>
        <li><a src="/admin_back/suggestion.action" href="javascript:;">投诉建议</a></li>
        <li class="head">QQ群管理</li>
        <li><a src="/admin_back/toQqGroup.action" href="javascript:;">添加QQ群</a></li>
        <li><a src="/admin_back/qqGroupByList.action" href="javascript:;">管理QQ群</a></li>
    </ul>
     <ul id="shop" class="left_date" style="display: block;">   
        ...
        <li class=""><a src="/admin_back/productList.action" href="javascript:;">商品列表</a></li>
        <li class=""><a src="/admin_back/index.action?id=hot20" href="javascript:;">在售商品管理</a></li>  
        <li class="head">商品分类管理</li>
        ...
        <li class="head">商品品牌管理</li>
        <li><a src="/admin_back/toAddProductBrand.action" href="javascript:;">添加商品品牌</a></li>
        <li class=""><a src="/admin_back/productBrandList.action" href="javascript:;">商品品牌列表</a></li>
...
<!--		<li><a src="/admin_back/latestList.action" href="javascript:;">未发货订单</a></li> 		-->
		<li class="head">发货管理</li>
       	<li><a src="/admin_back/latestList.action?typeId=3" href="javascript:;">已发货管理</a></li>
        <li><a src="/admin_back/latestList.action?typeId=2" href="javascript:;">未发货管理</a></li> 
        ...
        <li><a src="/admin_back/shareByStatus.action?tId=0" href="javascript:;">已晒单管理</a></li>
        <li><a src="/admin_back/shareByStatus.action?tId=-1" href="javascript:;">未晒单管理</a></li>
        <li><a src="/admin_back/shareList.action?typeId=hot20" href="javascript:;">晒单审核</a></li>
<!--        <li><a src="/admin_back/shareList.action?typeId=hot20" href="javascript:;">晒单评论管理</a></li>-->
        <li class="head">账单管理</li>
        <li><a src="/admin_back/totalRecharge.action" href="javascript:;">充值消费统计</a></li>
        <li><a src="/admin_back/totalOverplus.action?tId=-1" href="javascript:;">剩余财富统计</a></li>
    </ul>
     <ul id="user" class="left_date" style="display: none;">   
        ...
        <li><a src="/admin_back/toUserConfigure.action" href="javascript:;">会员福利配置</a></li>
		...
		<li><a src="/admin_back/orderdetailaddressList.action" href="javascript:;">快递管理</a></li>
...
<!--    </ul>    -->
     <ul id="yunapp" class="left_date" style="display: none;">     	
		...
		<li><a src="/admin_back/qqSetInfo.action" href="javascript:;">QQ登陆</a></li>
		<li><a src="/admin_back/wxSetInfo.action" href="javascript:;">微信登陆</a></li>
		<li><a src="/admin_back/qqGyjjNumber.action" href="javascript:;">公益基金设置</a></li>  
    </ul>
	 <div style="padding:30px 10px; color:#ccc">
     	<p>
        	&copy; 2015 <%=ApplicationListenerImpl.sysConfigureJson.getDomain()%><br />
			All Rights Reserved.
        </p>
     </div>
</div>
