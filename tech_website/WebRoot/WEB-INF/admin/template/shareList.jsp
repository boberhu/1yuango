...
<s:iterator value="ShareJSONList" var="ShareJSONLs">
	...
	<%-- <td style="height: 30px;overflow: hidden;float: left;" title="${ShareJSONLs.shareContent }">${ShareJSONLs.shareContent }</td> --%>
