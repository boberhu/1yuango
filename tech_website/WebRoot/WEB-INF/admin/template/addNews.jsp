...
<html>
  ...
  <div class="header lr10">
	    <a href="/admin_back/toAddNews.action">添加新闻</a><span class="span_fenge lr5">|</span><a href="/admin_back/newsList.action">新闻列表</a><span class="span_fenge lr5">|</span><a href="/admin_back/replaceNews.action">更新新闻</a><span class="span_fenge lr5">|</span>
	</div>
  <div class="bk10"></div>
  <div class="table_form lr10" style="">
	...
	<table width="100%" cellspacing="0" cellpadding="0" style="">
        ...
        <tr>
			...
			<td>
			<input type="text" class="input-text wid100" id="time" name="news.postDate" value="${news.postDate }" />
			</td>
		</tr>
		<tr style="">
			<td height="300" align="right"><font color="red">*</font>内容详情：</td>
			<td >
           		<textarea id="editor" name="news.content" style="width:1024px;height:500px;">${news.content }</textarea>
