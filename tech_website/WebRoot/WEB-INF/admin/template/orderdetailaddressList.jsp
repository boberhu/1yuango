  ...
  <table width="100%" cellspacing="0">
    <thead>
		<tr>
            ...
            <th width="5%" align="center">发货备注</th>
    ...
    <s:iterator value="orderdetailaddressList" var="orderdetailaddresss" status="st">
    		<tr >
			<td ><a href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/lotteryDetail/${orderdetailaddresss.orderDetailId }.html" target="_blank">${orderdetailaddresss.orderDetailId }</a></td>
			...
			<td >${orderdetailaddresss.deliverTime }</td>
			<td >${orderdetailaddresss.deliverRemarks }</td>
			<td align="center"><a target="_blank" href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/lotteryDetail/${orderdetailaddresss.orderDetailId }.html">订单详情</a></td>
		</tr>
		</s:iterator>
  	</tbody>
