	...
	<body>
		<div class="block-flat">
			...
			<div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="text" value="" name="product.productName" id="keyword" class="form-control" placeholder="请输入..." />
                </div>
				...
				<table id="datatable" class="table table-bordered dataTable"
					...
					<s:iterator value="userList" var="users" status="st">
						<s:if test="#st.odd == true">
							...
							<td class="center ">
							<a href="javascript:alert('无权修改');"><button class="btn btn-warning btn-flat" type="button">修改</button></a>
							<button class="btn btn-danger btn-flat" type="button">删除</button></td>
						</tr>
						</s:if>
						<s:else>
