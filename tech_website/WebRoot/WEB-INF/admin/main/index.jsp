	...
	<div class="row">
		...
		<div class="col-sm-6 col-md-6">
			<div class="block-flat">
				...
				<div class="content">
					<h4>欢迎使用1元夺宝源码，本源码为 java 语言编写，拥有最好的安全性能，程序可部署集群服务，不怕人气爆棚，该程序不邦定域名，不做任何限制，
					可永久使用更新，您有任何好的意见可与作者联系，我们共同不断完善系统，程序提供永久升级服务。我们可定制开发功能，如果你有需要请联系我们。（按功能复杂成度收费）
					</h4>
					<p></p>
					<p class="text-right">惊喜夺宝</p>
					<h4>www.egouos.com</h4>
					<p class="lead">感谢您的支持，我们会用心做的更好！</p>
					<p class="text-right">购买程序请联系QQ：30221336</p>
				</div>
			</div>
		</div>			
	</div>
