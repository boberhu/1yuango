  ...
  <div class="block-flat">
          <div class="content">
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" placeholder="请输入商品名称" class="form-control" name="product.productName" value="${product.productName }" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" placeholder="请输入商品标题" class="form-control" name="product.productTitle" value="${product.productTitle }" />
                </div>
              </div>
              <div class="form-group">
