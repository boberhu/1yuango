...
<html>
  ...
  <input type="hidden" id="backUrl" name="backUrl" value=""/>
 	...
 	<div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="text" value="" name="product.productName" id="keyword" class="form-control" placeholder="请输入商品名称" />
                </div>
              </div>
 	...
 	<table border="1px;" width="1024px;">
		...
		<s:iterator value="productList" var="products">
	 		<tr>
	 			...
	 			<td><a name="toUpdate" ids="${products.productId }" href="javascript:;">[编辑]</a> <a href="/admin_back/toAddProductImg.action?id=${products.productId }">[添加展示图片]</a>
