        ...
        <div class="block-flat">
          ...
          <div class="content">
            <form action="/admin_back/addProductType.action" method="post" class="form-horizontal">
              ...
              <div class="col-sm-7">
                <input type="text" placeholder="请输入分类名称" name="producttype.typeName" value="${producttype.typeName }" class="form-control parsley-validated"  />
              </div>
              </div>
              <div class="form-group">
              <label class="col-sm-3 control-label" >父分类ID</label>
              <div class="col-sm-7">
                <input type="text" placeholder="请输入父分类ID" name="producttype.ftypeId" value="${producttype.ftypeId }" class="form-control parsley-validated" />
              </div>
              </div>
              <div class="form-group">
              <label class="col-sm-3 control-label" >子分类ID</label>
              <div class="col-sm-7">
                <input type="text" placeholder="请输入子分类ID" name="producttype.stypeId" value="${producttype.stypeId }" class="form-control parsley-validated" />
              </div>
              </div>
              <div class="form-group">
