  ...
  implements BinaryEncoder, BinaryDecoder
{
  ...
  static
  {
    ...
    for (int j = 0, i = 26; i <= 51; j++)
    {
      lookUpBase64Alphabet[i] = ((byte)(97 + j));i++;
    }
    for (int j = 0, i = 52; i <= 61; j++)
    {
  ...
  public static byte[] encodeBase64(byte[] binaryData, boolean isChunked)
  {
    ...
    for (i = 0; i < numberTriplets; i++)
    {
      ...
      byte val1 = 
        (b1 & 0xFFFFFF80) == 0 ? (byte)(b1 >> 2) : (byte)(b1 >> 2 ^ 0xC0);
      byte val2 = 
        (b2 & 0xFFFFFF80) == 0 ? (byte)(b2 >> 4) : (byte)(b2 >> 4 ^ 0xF0);
      byte val3 = 
        (b3 & 0xFFFFFF80) == 0 ? (byte)(b3 >> 6) : (byte)(b3 >> 6 ^ 0xFC);
