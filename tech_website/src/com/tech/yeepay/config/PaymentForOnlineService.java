package com.tech.yeepay.config;
...
public class PaymentForOnlineService
{
  ...
  private static String p1_MerId = ApplicationListenerImpl.sysConfigureJson.getYeepayPartner();
  private static String queryRefundReqURL = "https://www.yeepay.com/app-merchant-proxy/command";
  private static String keyValue = ApplicationListenerImpl.sysConfigureJson.getYeepayKey();
