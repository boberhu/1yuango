package com.tech.alipay.util.httpClient;
...
public class HttpProtocolHandler
{
    ...
    throws HttpException, IOException
  {
    ...
    else
    {
      ...
      ((PostMethod)method).setRequestEntity(new MultipartRequestEntity((Part[])parts.toArray(new Part[0]), new HttpMethodParams()));
    }
